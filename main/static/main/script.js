...
var arrayFotos = document.getElementsByClassName("foto")
var arrayMarcas = document.getElementsByClassName("square")
//arrayTextos = ["Viaje a Roma", "Pipo y yo", "Mi mejor curry"]

var str_arrayTextos = document.currentScript.getAttribute('foto_textos_array');
var str_arrayTextos_limpio = str_arrayTextos.replace(/[\])}[{'"(]/g, '');
var arrayTextos = str_arrayTextos_limpio.split(",")
